...
: EditorWindow
{
    ...
    private static HgAnimationKey _THIS = null;
    ...
    private EMenuPos m_eMenuPos = EMenuPos.Right;
    ...
    public static void ShowWindow()
    {
        ...
        _THIS = EditorWindow.GetWindow<HgAnimationKey>("AniEventKey");//, typeof(SceneView));
        _THIS.Init();
    }
    ...
    private static void SortTime(ref List<AnimationEvent> i_list)
    {
        ...
        i_list.Sort(delegate(AnimationEvent a, AnimationEvent b)
        {
            ...
            nCount++;
            HgUtil.DisplayProgressBar("AniEvent Sort", string.Format("{0} {1} {2}", a.time, strCompare, b.time), nCount, nTotalCount);
