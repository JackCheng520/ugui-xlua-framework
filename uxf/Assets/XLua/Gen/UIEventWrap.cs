...
namespace XLua.CSObjectWrap
{
    ...
    public class UIEventWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UIEvent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UIEvent constructor!");
        ...
        static int _g_get_injections(RealStatePtr L)
        {
		    try {
                ...
                UIEvent gen_to_be_invoked = (UIEvent)translator.FastGetCSObj(L, 1);
